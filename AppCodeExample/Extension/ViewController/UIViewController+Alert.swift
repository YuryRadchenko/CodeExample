...
extension UIViewController {
    ...
    internal func alert(error: AppError) {
...
extension UIViewController {
    ...
    internal func alertError(_ error: AppError, withActions actions: [AlertAction] = [.default], completion:@escaping (_ action: AlertAction) -> Void) {
